...
module alt_ddr2_agx2_phy (
	...
	alt_ddr2_agx2_phy_alt_mem_phy	alt_ddr2_agx2_phy_alt_mem_phy_inst(
	...
	defparam
		alt_ddr2_agx2_phy_alt_mem_phy_inst.FAMILY = "Arria II GX",
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		alt_ddr2_agx2_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		alt_ddr2_agx2_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 8,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		alt_ddr2_agx2_phy_alt_mem_phy_inst.DQS_PHASE = 9000,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.DWIDTH_RATIO = 4,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 64,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 14,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 3,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 8,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 8,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 2,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 5000,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "5000 ps",
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 1123,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 68,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 56,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 1,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		alt_ddr2_agx2_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0,
		alt_ddr2_agx2_phy_alt_mem_phy_inst.INVERT_POSTAMBLE_CLK = "false";
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="alt_ddr2_agx2_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="alt_ddr2_agx2_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Arria II GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="alt_ddr2_agx2_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Arria II GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+alt_ddr2_agx2_phy_alt_mem_phy_seq_wrapper;+alt_ddr2_agx2_phy_alt_mem_phy_reconfig;+alt_ddr2_agx2_phy_alt_mem_phy_pll;+alt_ddr2_agx2_phy_alt_mem_phy_delay;+alt_ddr2_agx2_phy_alt_mem_phy_dq_dqs --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=D:\user\arvio\svn\funbase_ip_library\trunk\TUT\ip.hwp.storage\ddrx\alt_ddr2_agx2.comp\2.0\hdl/alt_ddr2_agx2_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="alt_ddr2_agx2_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// IPFS_FILES: alt_ddr2_agx2_phy_alt_mem_phy_seq_wrapper.vo;
// =========================================================

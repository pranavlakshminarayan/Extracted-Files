...
// ============================================================
// Megafunction Name(s):
// 			a2_ddr2_dimm_1GB_phy_alt_mem_phy
// ============================================================
...
module a2_ddr2_dimm_1GB_phy (
	...
	a2_ddr2_dimm_1GB_phy_alt_mem_phy	a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst(
	...
	defparam
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.FAMILY = "Arria II GX",
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 8,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.DQS_PHASE = 9000,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.DWIDTH_RATIO = 4,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 64,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 14,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 3,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 8,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 8,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 2,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 5000,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "5000 ps",
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 1123,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 68,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 48,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 1,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0,
		a2_ddr2_dimm_1GB_phy_alt_mem_phy_inst.INVERT_POSTAMBLE_CLK = "false";
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="a2_ddr2_dimm_1GB_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "local_if_clk_mhz_label" value="100,0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="Custom (Micron ArriaIIGX_DDR2_Kit(MT8HTF12864HY-800G1))"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_trtp_ns" value="8.8"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_tfaw_ns" value="35.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_tcl_30_fmax" value="400.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="a2_ddr2_dimm_1GB_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Arria II GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="a2_ddr2_dimm_1GB_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Arria II GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+a2_ddr2_dimm_1GB_phy_alt_mem_phy_seq_wrapper;+a2_ddr2_dimm_1GB_phy_alt_mem_phy_reconfig;+a2_ddr2_dimm_1GB_phy_alt_mem_phy_pll;+a2_ddr2_dimm_1GB_phy_alt_mem_phy_delay;+a2_ddr2_dimm_1GB_phy_alt_mem_phy_dq_dqs --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=D:\svn\funbase\shared_lib\hw_lib\ips\storage\hibi_mem_dma\alt_mem_ctrl\a2_ddr2_dimm_1GB/a2_ddr2_dimm_1GB_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="a2_ddr2_dimm_1GB_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// IPFS_FILES: a2_ddr2_dimm_1GB_phy_alt_mem_phy_seq_wrapper.vo;
// =========================================================

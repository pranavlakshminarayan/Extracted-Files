...
`endif
	...
	wire  tx_reconfig;
	wire  [10:0]  w325w;
	wire  [2:0]  w_rx_eqa535w;
	wire  [2:0]  w_rx_eqb534w;
	wire  [2:0]  w_rx_eqc533w;
	wire  [2:0]  w_rx_eqd532w;
	wire  [2:0]  w_rx_eqv536w;
	wire  wr_pulse;
	wire  write_addr_inc;
	...
	assign
		wire_rx_eqctrl_reg_d = (({4{read_state}} & (((({{2{1'b0}}, (w_rx_eqv536w[2] & (~ (w_rx_eqv536w[1] ^ w_rx_eqv536w[0]))), (((w_rx_eqv536w[2] & w_rx_eqv536w[1]) & w_rx_eqv536w[0]) | (((~ w_rx_eqv536w[2]) & (~ w_rx_eqv536w[1])) & (~ w_rx_eqv536w[0])))} & {4{(((((w_rx_eqd532w[2] & w_rx_eqd532w[1]) & w_rx_eqd532w[0]) & (~ ((w_rx_eqc533w[2] & w_rx_eqc533w[1]) & w_rx_eqc533w[0]))) & (~ ((w_rx_eqb534w[2] & w_rx_eqb534w[1]) & w_rx_eqb534w[0]))) & (~ ((w_rx_eqa535w[2] & w_rx_eqa535w[1]) & w_rx_eqa535w[0])))}}) | ({1'b0, 1'b1, ((w_rx_eqv536w[2] & w_rx_eqv536w[1]) & w_rx_eqv536w[0]), ((w_rx_eqv536w[2] & (~ w_rx_eqv536w[1])) & (~ w_rx_eqv536w[0]))} & {4{(((((w_rx_eqd532w[2] & w_rx_eqd532w[1]) & w_rx_eqd532w[0]) & ((w_rx_eqc533w[2] & w_rx_eqc533w[1]) & w_rx_eqc533w[0])) & (~ ((w_rx_eqb534w[2] & w_rx_eqb534w[1]) & w_rx_eqb534w[0]))) & (~ ((w_rx_eqa535w[2] & w_rx_eqa535w[1]) & w_rx_eqa535w[0])))}})) | ({w_rx_eqv536w[2], (~ w_rx_eqv536w[2]), (((w_rx_eqv536w[2] & w_rx_eqv536w[1]) & w_rx_eqv536w[0]) | (((~ w_rx_eqv536w[2]) & (~ w_rx_eqv536w[1])) & (~ w_rx_eqv536w[0]))), ((~ w_rx_eqv536w[1]) & (~ (w_rx_eqv536w[2] ^ w_rx_eqv536w[0])))} & {4{(((((w_rx_eqd532w[2] & w_rx_eqd532w[1]) & w_rx_eqd532w[0]) & ((w_rx_eqc533w[2] & w_rx_eqc533w[1]) & w_rx_eqc533w[0])) & ((w_rx_eqb534w[2] & w_rx_eqb534w[1]) & w_rx_eqb534w[0])) & (~ ((w_rx_eqa535w[2] & w_rx_eqa535w[1]) & w_rx_eqa535w[0])))}})) | ({1'b1, ((w_rx_eqv536w[2] | w_rx_eqv536w[1]) | w_rx_eqv536w[0]), (((~ w_rx_eqv536w[1]) & (~ (w_rx_eqv536w[2] ^ w_rx_eqv536w[0]))) | ((w_rx_eqv536w[2] & w_rx_eqv536w[1]) & w_rx_eqv536w[0])), (((~ w_rx_eqv536w[1]) & (~ w_rx_eqv536w[0])) | ((w_rx_eqv536w[2] & w_rx_eqv536w[1]) & w_rx_eqv536w[0]))} & {4{(((((w_rx_eqd532w[2] & w_rx_eqd532w[1]) & w_rx_eqd532w[0]) & ((w_rx_eqc533w[2] & w_rx_eqc533w[1]) & w_rx_eqc533w[0])) & ((w_rx_eqb534w[2] & w_rx_eqb534w[1]) & w_rx_eqb534w[0])) & ((w_rx_eqa535w[2] & w_rx_eqa535w[1]) & w_rx_eqa535w[0]))}}))) | ({4{write_state}} & rx_eqctrl));
	assign
	...
	assign
		...
		illegal_wr_mode_type = ((~ reconfig_mode_sel[2]) & (~ (reconfig_mode_sel[1] & (~ reconfig_mode_sel[0])))),
		...
		rd_pulse = ((((((~ dprio_pulse) & (~ write_done)) & (~ wr_rd_pulse_reg)) & (write_state & (((~ header_proc) & (~ reset_reconf_addr)) & ((~ is_tier_1) | (is_tier_1 & ((((is_rcxpat_chnl_en_ch | is_cruclk_addr0) | write_skip) | bonded_skip) | is_protected_bit)))))) | ((read_state & (~ dprio_pulse)) & (~ read_done))) & (~ is_illegal_reg_d)),
		...
		w_rx_eqa535w = wire_dprio_dataout[14:12],
		w_rx_eqb534w = wire_dprio_dataout[11:9],
		w_rx_eqc533w = wire_dprio_dataout[8:6],
		w_rx_eqd532w = wire_dprio_dataout[5:3],
		w_rx_eqv536w = wire_dprio_dataout[2:0],
...
module altpcie_reconfig_4sgx (
	...
	wire  busy = sub_wire2;
	wire [4:0] tx_preemp_1t_out = sub_wire3[4:0];

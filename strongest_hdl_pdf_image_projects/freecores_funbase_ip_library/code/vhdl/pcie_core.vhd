-- Generated by PCI Express Compiler 9.1 [Altera, IP Toolbench 1.3.0 Build 304]
-- ************************************************************
...
ENTITY pcie_core IS
	PORT (
		...
		TxsAddress_i	: IN STD_LOGIC_VECTOR (17 DOWNTO 0);
...
ARCHITECTURE SYN OF pcie_core IS
	...
	GENERIC (
		...
		CB_A2P_ADDR_MAP_FIXED_TABLE	: STD_LOGIC_VECTOR := X"";
		CB_P2A_AVALON_ADDR_B0	: STD_LOGIC_VECTOR := X"00000000";
		CB_P2A_AVALON_ADDR_B1	: STD_LOGIC_VECTOR := X"00000000";
		CB_P2A_AVALON_ADDR_B2	: STD_LOGIC_VECTOR := X"80001000";
...
BEGIN
	...
	GENERIC MAP (
		...
		CG_COMMON_CLOCK_MODE => 0,
		CG_IMPL_CRA_AV_SLAVE_PORT => 1,
		INTENDED_DEVICE_FAMILY => "Arria II GX",
		CB_A2P_ADDR_MAP_NUM_ENTRIES => 2,
		CB_A2P_ADDR_MAP_PASS_THRU_BITS => 20,
		CB_A2P_ADDR_MAP_IS_FIXED => 0,
		CB_A2P_ADDR_MAP_FIXED_TABLE => X"",
		CB_P2A_AVALON_ADDR_B0 => X"00000000",
		CB_P2A_AVALON_ADDR_B1 => X"00000000",
		CB_P2A_AVALON_ADDR_B2 => X"80001000",
		...
		diffclock_nfts_count => 0,
		sameclock_nfts_count => 0,
